...
public class SimpleReceive {
	private static final String EH_NAMESPACE_CONNECTION_STRING = "Endpoint=sb://kafkatestin.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=tQp4AG95dXZ2vFPkuwJg9ca/AaqPNMSgU8qIBpuDsEA=";
	private static final String eventHubName = "testeventhub";
	private static final String STORAGE_CONNECTION_STRING = "DefaultEndpointsProtocol=https;EndpointSuffix=core.windows.net;AccountName=azurekafkapoc;AccountKey=8kv1I5Y/jGG6+YGO9lVO3CakOMugKabLLrImXsBSYEIRZQ6xOzTrPeckR9rGeg4upSegnjsUTQhUUJHKEDTZkQ==";
	...
	public static void main(String[] args) throws Exception {
		...
		EventProcessorClientBuilder eventProcessorClientBuilder = new EventProcessorClientBuilder()
				...
				//.proxyOptions("http://bccluster.inet.westpac.co.nz:80/")
